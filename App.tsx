...
const Nav: React.FC = () => (
  <nav className="fixed top-0 left-0 w-full px-8 py-8 flex justify-between items-center z-50 mix-blend-difference text-manor-bg">
    <div className="text-xs tracking-[0.2em] font-sans uppercase">Manor & Co.</div>
    <div className="flex gap-8 text-xs tracking-[0.2em] font-sans uppercase cursor-pointer">
...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative min-h-screen w-full flex flex-col justify-between px-6 pt-32 pb-12 md:px-16 md:pt-48 md:pb-20 overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 h-full">
        ...
        >
          <div className="overflow-hidden">
            <motion.h1 variants={fadeInUp} className="font-serif text-6xl md:text-8xl lg:text-9xl leading-[0.9] text-manor-text tracking-tight">
              The <span className="italic font-light">Art</span> <br />
              of Living.
            </motion.h1>
          </div>
          
          <div className="overflow-hidden mt-12 max-w-md">
        ...
        {/* Image */}
        <div className="lg:col-span-5 relative h-[60vh] lg:h-auto mt-12 lg:mt-0">
            <motion.div 
              style={{ y }}
            ...
            <motion.div 
              ...
              className="absolute -left-12 bottom-12 -rotate-90 origin-bottom-left text-[10px] tracking-[0.3em] uppercase text-manor-text/60 whitespace-nowrap"
            >
...
const Philosophy: React.FC = () => {
  return (
    <section className="w-full py-32 px-6 md:px-16 border-t border-manor-text/10">
...
const Portfolio: React.FC = () => {
  ...
  return (
    <section className="w-full py-24 px-6 md:px-16 border-t border-manor-text/10 min-h-screen">
            ...
            <div className="flex flex-col">
              {PROPERTIES.map((property) => (
                <motion.div 
                  ...
                  className="group relative flex flex-col md:flex-row md:items-baseline justify-between py-12 border-b border-manor-text/10 cursor-pointer transition-colors duration-500 hover:border-manor-text/40"
                >
                  ...
                  <div className="flex items-center gap-8 mt-4 md:mt-0 font-sans text-xs tracking-widest text-manor-text/60">
                    <span>{property.location}</span>
                    <span className="hidden md:block w-px h-3 bg-manor-text/20"></span>
                    <span className="hidden md:block">{property.sqft}</span>
                  </div>
                </motion.div>
              ))}
            </div>
...
const Footer: React.FC = () => {
  return (
    <footer className="w-full py-24 px-6 md:px-16 border-t border-manor-text/10 flex flex-col items-center justify-center text-center">
      <h2 className="font-serif text-5xl md:text-7xl italic text-manor-text mb-8">Manor.</h2>
      
      <div className="flex flex-col md:flex-row gap-8 md:gap-16 font-sans text-xs tracking-[0.2em] uppercase text-manor-text/60 mb-16">
      ...
      <div className="font-sans text-[10px] text-manor-text/30">
